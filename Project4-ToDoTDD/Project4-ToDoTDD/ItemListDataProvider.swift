...
extension ItemListDataProvider: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        guard let itemM = itemManager else { return 0 }
        ...
        switch itemSection {
            case .toDo:
                numberOfRows = itemM.toDoCount
            case .done:
                numberOfRows = itemM.doneCount
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "123", for: indexPath) as! ItemCell
...
extension ItemListDataProvider: UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch itemSection {
        case .toDo:
            NotificationCenter.default.post(name: NSNotification.ItemSelectedNotification, object: self, userInfo: ["index": indexPath.row])
        case .done:
            break;
